...
/**
 * Customizes the header used for editing a or list anything else.
 ...
 *
 * @param onClick action what happens when clicking the edit button
 * @param title Title displayed on the left
 */
@Composable
fun ListEditHeader(
    onClick: () -> Unit,
